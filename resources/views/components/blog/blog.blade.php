...
<section class="blog">
    <div class="container mx-auto">
        <h3 class="blog__title h3 mb-[50px] text-center xl:text-left mt-10">
            Kabar Berita Dari Kami
        </h3>
        <!-- blog posts -->
        <div class="grid grid-cols-3 xl:grid-cols-3 gap-y-6 xl:gap-y-0 items-center xl:justify-between mb-[50px]">
            <!-- post 1 -->
            <div
