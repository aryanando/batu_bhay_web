    ...
    <div class="container mx-auto mt-8 xl:-mt-[144px]">
        ...
        <div class="grid xl:grid-cols-4 gap-5 px-8 xl:px-0">
            ...
            <div
                ...
                <div class="mb-[15px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="75px" height="75px"
                        class=" fill-slate-500" viewBox="0 0 48 48">
                        <g fill="none" stroke="#64748b" stroke-width="4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M14.54 20.019c-1.688-2.075-3.272-2.521-4.754-1.337c-2.223 1.776-2.861 7.968-1.073 13.427c1.789 5.459 5.267 12.893 12.289 12.893c7.021 0 8.682-7.48 11.546-12.002c2.865-4.522 4.38-8.885 1.573-14.318" />
                            <path stroke-linecap="round"
                                d="M11 18.037A643.145 643.145 0 0 0 7 12c-1.446-2.145 2.251-4.918 4-3.032c1.166 1.258 2.715 3.11 4.647 5.557" />
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15.024 25.64c-.485-6.064-.09-10.012 1.182-11.845c1.91-2.75 5.457-3.792 8.798-3.792c1.988 0 3.805.847 5.448 2.541" />
                            <path
                                d="M41 12.613c.586 2.036-.37 3.897-3.316 4.318c-2.945.421-5.153 1.902-6.745 3.148c-1.593 1.246-4.44 5.026-5.003 6.923c-.562 1.898-3.776.153-4.639-.605c-.863-.757-1.712-2.416 0-4.151c1.712-1.735 1.341-2.081 1.341-3.84c0-1.76 9.362-7.58 14.635-8.112c1.172-.068 3.142.282 3.727 2.319Z"
                                clip-rule="evenodd" />
                            <path stroke-linecap="round"
                                d="M23.008 4v5.263m-2.701 1.455c-3.018-3.793-5.451-5.91-7.3-6.35m3.997 2.661l.99-4.067m17.619 7.756c-.322 1.104-.322 2.14 0 3.106c.322.967 1.013 2.002 2.071 3.107" />
                        </g>
                    </svg>
                </div>
                <!-- grid item title -->
                ...
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menandengan berbagai keluhan yang berkaitan dengan sistem organ bagian dalam dan
                    keluhan penyakit seperti ginjal, hati, pencernaan, jantung dan lain sebagainya.
                </p>
            </div>
            <!-- grid item -->
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menangani masalah kesehatan pada sistem saluran kemih, termasuk ginjal, kandung kemih,
                    kelenjar adrenal, dan saluran kemih.
                </p>
            </div>
            <!-- grid item -->
            <div
                ...
                <div class="mb-[15px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75"
                        class=" fill-slate-500" viewBox="0 0 24 24">
                        <path
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menangani cedera dan penyakit pada sistem muskoloskeletal tubuh, mencakup tulang,
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu perawatan gigi untuk segala usia. Melakukan pemeriksaan menyeluruh terhadap mulut
                    (termasuk gigi, gusi, dan struktur lainnya), pembersihan profesional, serta diskusi tentang
                    kesehatan gigi secara umum.
                </p>
            ...
            <div
                ...
                <div class="mb-[15px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="75px" height="75px"
                        class=" fill-slate-500" viewBox="0 0 64 64">
                        <path
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu mengobati penyakit, cedera, atau kondisi gawat darurat pada tubuh melalui metode bedah
                    (operatif) dan obat-obatan. Melakukan diagnosis sesuai keahlian dan ilmu yang dimiliki untuk
                    menentukan perlu atau tidaknya prosedur bedah dilakukan.
                </p>
            ...
            <div
                ...
                <div class="mb-[15px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="75px" height="75px"
                        class=" fill-slate-500" viewBox="0 0 256 256">
                        <path
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menangani gangguan sistem saraf, mulai dari mendiagnosis, memberikan pengobatan, hingga
                    melakukan operasi pada otak dan saraf. Area sistem saraf yang dapat ditangani adalah saraf pusat
                    (otak dan saraf tulang belakang), serta saraf tepi yang berada di seluruh bagian tubuh.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu melakukan pemeriksaan, perawatan, serta diagnosis yang berhubungan dengan penyakit mata
                    dan gangguan penglihatan. Memiliki kompetensi untuk melakukan operasi mata.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu para ibu dalam melakukan pemeriksaan kesehatan sistem reproduksi maupun kandungan,
                    karena pemeriksaan organ reproduksi secara teratur sangat penting untuk menjaga kesehatan sistem
                    reproduksi.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menangani berbagai masalah kesehatan yang berhubungan dengan telinga, hidung, dan
                    tenggorokan. Bertanggung jawab menangani penyakit-penyakit tertentu yang terjadi di area leher
                    dan kepala.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu menangani berbagai keluhan dan masalah kesehatan yang terkait kulit dan kelamin, baik
                    pada orang dewasa, anak-anak, orang lanjut usia, maupun ibu hamil.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu mendiagnosis dan mengobati penyakit pada bayi, anak-anak dan remaja, serta memonitor
                    tumbuh kembang anak dan merencanakan intervensi untuk mendukung tumbuh kembang dan memelihara
                    kesehatan anak.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Membantu pemeriksaan anatomi, fungsi dan gangguan yang memengaruhi sistem saraf. Melakukan
                    perawatan dan mengelola gangguan pada otak dan sumsum tulang belakang.
                </p>
            ...
            <div
                ...
                <!-- grid item description -->
                <p class="font-light leading-normal max-w-[300px]">
                    Layanan kesehatan untuk masalah pernapasan, seperti asma, bronkitis, pneumonia, emfisema, dan
