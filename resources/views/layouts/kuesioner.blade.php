            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <button data-modal-hide="popup-modal" type="button" onclick="window.location='https://webapp.batubhayangkara.com/laporan/harianpoli.phphttps://webapp.batubhayangkara.com/laporan/pasienranap.php'"
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/chatify">Live Chat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/blog_admin">Blog Admin</a>
                        </li>
                    </ul>
